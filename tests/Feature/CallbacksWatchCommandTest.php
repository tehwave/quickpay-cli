...
use App\Callbacks\CallbackWatcher;
use App\Callbacks\CallbackWatcherFactory;
use App\Commands\CallbacksWatchCommand;
...
it('documents foreground streaming behavior without offering json mode', function () {
    $command = new CallbacksWatchCommand;
...
it('distinguishes Quickpay server callback urls from local forwarding in command help', function (string $commandClass) {
    ...
    PaymentsLinkCommand::class,
    PaymentsCaptureCommand::class,
    PaymentsRefundCommand::class,
    PaymentsCancelCommand::class,
]);
