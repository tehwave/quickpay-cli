...
class ApiRequestCommand extends AuthenticatedCommand
{
    protected $signature = 'api
        ...
        {path : Relative Quickpay API path, for example /payments}
        {--query=* : Query parameter as key=value; repeatable}
        {--data=* : JSON request field as key=value; repeatable}
        {--data-json= : JSON object request body}
        {--header=* : Additional safe header as name:value; repeatable}
        {--yes : Skip the interactive confirmation for mutations}
